...
/**
 * Clase principal para probar la ejecuci�n de ProjectService Se recomienda
 * descomentar el c�digo de los ejercicios conforme se vayan realizando
 * 
 * @author Paco
 * 
...
public class P2Main {
	...
	public static void main(String[] args) {
		...
		// Project acmeProject =
		// service.createBigDataProject("Persistence
		// Layer",proyDepartment,projectManager,new BigDecimal(1500000.99));

		Project acmeProject = em.find(Project.class, 47);
		// System.out.println(project.getName());
		// service.assignTeam(project,10001,10005);
		...
		/*
		 * Eliminamos la informaci�n creada * em.getTransaction().begin(); Manager m =
		 * em.merge(projectManager); Project p = em.merge(acmeProject); em.remove(p);
		 * em.createNativeQuery("Delete from manager where emp_no = " +
		 * m.getId()).executeUpdate(); em.getTransaction().commit();
		 */
